    ...
    where TEntity : class
{
    ...
    Task<TEntity?> RequestAsync(TEntityContext entityContext, ISessionRequestOptions<TEntityContext, TEntity> options,
        CancellationToken cancellationToken = default);

    Task<TEntity?> RequestAsync(TEntityContext entityContext,
